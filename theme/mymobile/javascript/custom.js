...
//$.mobile.defaultTransition = "none";
    ...
    $('.maincalendar .filters a, li.activity.scorm a, div.files a, #page-user-filesPAGE li div a, .maincalendar .bottom a, .section li.url.modtype_url a, .resourcecontent .resourcemediaplugin a, #underfooter .noajax a').attr("data-ajax", "false");
...
$('div.path-course-view, .path-course-view div.generalpage').live('pagebeforecreate',function(event, ui){
    ...
    $('.section .resource.modtype_resource a').attr("rel", "external");
...
//course boxes on category pages and front page stuff
    ...
    $('.unlist .name a:last').addClass("ui-corner-bottom ui-controlgroup-last");
...
$('div#page-mod-quiz-viewPAGE, div#page-mod-quiz-attemptPAGE, div#page-mod-quiz-summaryPAGE, div#page-mod-quiz-reviewPAGE').live('pagebeforecreate',function(event, ui){
    ...
    $('div.submitbtns a, div.quizattemptcounts a').attr("data-role", "button");
...
$('div').live('pagecreate',function(event, ui){
        //lesson remove dupes also in cleanup
        
    $('#page-mod-lesson-viewPAGE div.ui-radio label:first-child').addClass("afirst");   
    $('#page-mod-wiki-createPAGE div.ui-radio label:first-child').addClass("afirst");   
    $('.path-calendar div.ui-radio label:first-child').addClass("afirst");
    $('.path-mod-lesson div.ui-radio label:first-child').addClass("afirst");
    ...
    $('.gradeparent, .pagelayout-report .no-overflow, .path-mod-choice .response, .resourcecontent.resourceimg, .usersubmissions .no-overflow, .path-course-report-log .generaltable, table.results.anonymous, table.surveytable').scrollview();
    
//image replacement
    $(this).find(".ithumb .course-content .summary img, .ithumb .course-content .activity.label img, .ithumb .sitetopic .no-overflow img, .ithumb .forumpost .maincontent img").click(function() {
